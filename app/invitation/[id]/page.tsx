...
import { Play, Pause, MapPin, Calendar as CalendarIcon, Heart, Share2, Music2, ChevronLeft, ChevronRight, Utensils, PartyPopper, Users, Wine, Camera, Star, ArrowLeft, Volume2, VolumeX, Edit, Shirt } from "lucide-react";
                            ...
                            <div className="grid grid-cols-1 gap-10">
                                {gallery.map((img, index) => (
                                    <motion.div key={index} variants={fadeInScale} className="relative mx-auto w-64 h-64 group perspective">
                                        <div className={`absolute inset-0 rounded-full border overflow-hidden transform group-hover:scale-105 transition-all duration-700 ${isNeon ? 'border-4 shadow-[0_0_20px_rgba(0,0,0,0.8)]' : isMinimal ? 'border-white border-8 shadow-lg' : 'border-white/20 shadow-[0_0_30px_rgba(0,0,0,0.5)]'}`} style={isNeon ? { borderColor: primaryColor, boxShadow: `0 0 20px ${primaryColor}` } : {}}>
