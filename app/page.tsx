        ...
        <div className="min-h-screen flex flex-col bg-gray-50 font-sans">
            ...
            <header className="bg-white py-4 px-6 md:px-12 flex items-center justify-between shadow-sm z-50 relative sticky top-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => {
                            const apkLink = localStorage.getItem('invita_apk_link');
                            if (apkLink) {
                                window.open(apkLink, '_blank');
                            } else {
                                alert('El link de descarga aún no está configurado. Por favor, configúralo en el panel de administración.');
                            }
                        }}
                        className="flex items-center gap-2 bg-gradient-to-r from-green-500 to-green-600 text-white px-3 md:px-5 py-2 rounded-md font-medium hover:from-green-600 hover:to-green-700 transition-all shadow-md hover:shadow-lg text-xs md:text-sm"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span className="hidden sm:inline">Descarga nuestra App</span>
                        <span className="sm:hidden">Descarga App</span>
                    </button>

                    <Link href="/admin" className="bg-deep-violet text-white px-4 md:px-6 py-2 rounded-md font-medium hover:bg-opacity-90 transition-colors shadow-md hover:shadow-lg text-xs md:text-sm">
